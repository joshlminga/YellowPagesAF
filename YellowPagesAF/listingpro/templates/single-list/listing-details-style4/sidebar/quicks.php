<div class="lp-listing-price-range lp-widget-inner-wrap">
    ...
    ?>
        <p class="pricey">
            <span class="pricey simptip-position-top simptip-movable" data-tooltip="<?php echo esc_attr( $dollar_tip ); ?>">
                <span class="currency-sign <?php if($dollars['dollars'] > 0){ echo 'green';}; ?>"><?php echo esc_attr( $dollars['symbol'] ); ?></span>
                <span class="currency-sign <?php if($dollars['dollars'] > 1){ echo 'green';}; ?>"><?php echo esc_attr( $dollars['symbol'] ); ?></span>
                <span class="currency-sign <?php if($dollars['dollars'] > 2){ echo 'green';}; ?>"><?php echo esc_attr( $dollars['symbol'] ); ?></span>
                <span class="currency-sign <?php if($dollars['dollars'] > 3){ echo 'green';}; ?> currency-sign-last"><?php echo esc_attr( $dollars['symbol'] ); ?></span>
            </span>
    ...
    ?>
        <p id="lp-report-listing">
            ...
            <a href="#" data-postid="<?php echo get_the_ID(); ?>"  data-reportedby="<?php echo esc_attr( $currentUserId ); ?>" data-posttype="listing" href="#" id="lp-report-this-listing"><?php echo esc_html__('Report Now!', 'listingpro'); ?></a>
        </p>
    <?php endif; ?>
