                ...
                <div class="input-group width-49-percent <?php echo esc_attr($hideWhatClass); ?>">
                    ...
                    <div class="<?php echo esc_attr($srchBr); ?>">
                        ...
                        <input type="hidden" autocomplete="off" id="lp_search_loc" name="lp_s_loc"
                               value="<?php if (isset($_GET['lp_s_loc'])) : echo esc_attr($_GET['lp_s_loc']); endif; ?>">
                    </div>
                        ...
                        <select class="<?php echo esc_attr($slct); ?>" name="lp_s_loc" id="searchlocation">
                            ...
                            if (!empty($sLoc)) {
                                ...
                                <option id="def_location"
                                        value="<?php echo esc_attr($sLoc); ?>"><?php echo esc_attr($sLocName); ?></option>
                                <?php
                            } elseif (!empty($sLocation)) { ?>
                                <option id="def_location"
                                        value="<?php echo esc_attr($sLocation); ?>"><?php echo esc_attr($sLocation); ?></option>
                                <?php
                            } else {
                                ?>
                                <option id="def_location"
                                        value=""><?php echo esc_attr($location_default_text); ?></option>
                                <?php
                            }
                            ?>
