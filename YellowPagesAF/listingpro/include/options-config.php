...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default' => 'tax_cats',
            'required' => array(
                array('top_banner_styles', '=', array('banner_view', 'banner_view3', 'banner_view2', 'banner_view_search_bottom', 'banner_view_category_upper', 'banner_view_search_inside'))
            )
        ),
        array(
            'id' => 'home_banner_cats',
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'validate_callback' => 'lp_option_mapzoom_validate_callback',
            'default' => 17,
        ),
        //end new code 2.6.15
    )
