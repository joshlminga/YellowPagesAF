	...
	public function setup_wizard_header() {
      ...
      if ( !defined('WP_LOAD_IMPORTERS') ) define('WP_LOAD_IMPORTERS', true);
            ...
            <form method="post" class="lp-demo-content-import-container">
                <div class="plugins-container-inner">
					...
					<p class="envato-setup-actions step">
						...
						<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
						   class="button button-large button-next"><?php esc_html_e( 'SKIP', 'listingpro' ); ?></a>
						<?php wp_nonce_field( 'envato-setup' ); ?>
						 <input type="submit" class="button-primary button button-large button-next"
							   value="<?php esc_attr_e( 'ACCEPT', 'listingpro' ); ?>" name="save_step"/>
					</p>
				</div>
            </form>
			<?php
		...
		public function envato_setup_ready() {
			...
			<img alt="image" src="<?php echo get_template_directory_uri().'/assets/images/setup/setup4.jpg' ?>"/>
